...
contract StabilityPoolErc20 is GstableBaseErc20, Ownable, CheckContract, IStabilityPoolErc20 {
    using GstableSafeMath128 for uint128;

    string constant public NAME = "StabilityPoolErc20";
    ...
    uint256 internal collAmount;  // deposited ether tracker
